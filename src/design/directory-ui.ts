...
const presets: Record<string, DirectoryUiPreset> = {
  ...
  'dlkautoparts.com': {
    ...
    label: 'Parts counter',
    shell: 'bg-[#fff6f6]',
    hero: 'border-b border-[#8CC7C4]/35 bg-[#fff6f6]',
    eyebrow: 'text-[#DB1A1A]',
    title: 'font-sans text-[#2C687B]',
    muted: 'text-[#2C687B]/75',
    panel: 'border border-[#8CC7C4]/35 bg-white shadow-[0_12px_32px_rgba(44,104,123,0.08)]',
    softPanel: 'border border-[#8CC7C4]/30 bg-[#fff6f6]',
    input: 'border border-[#8CC7C4]/40 bg-white text-[#2C687B]',
    primaryButton: 'bg-[#DB1A1A] text-white hover:bg-[#c41515]',
    secondaryButton: 'border border-[#8CC7C4]/40 bg-white text-[#2C687B] hover:bg-[#8CC7C4]/12',
    listGrid: 'grid gap-4 lg:grid-cols-2',
    cardFrame: 'group grid h-full overflow-hidden rounded-sm border border-[#8CC7C4]/35 bg-white shadow-[0_10px_28px_rgba(44,104,123,0.08)] transition duration-300 hover:border-[#DB1A1A] hover:shadow-[0_18px_42px_rgba(44,104,123,0.14)] sm:grid-cols-[180px_1fr]',
    cardImage: 'aspect-[4/3] sm:aspect-auto sm:min-h-full',
    badge: 'bg-[#DB1A1A] text-white',
    chip: 'border border-[#8CC7C4]/35 bg-[#fff6f6] text-[#2C687B]',
    detailHero: 'bg-[#2C687B] text-white',
    detailPanel: 'border border-[#8CC7C4]/35 bg-white shadow-[0_14px_34px_rgba(44,104,123,0.08)]',
    detailAside: 'border border-[#DB1A1A]/50 bg-[#fff6f6]',
    relatedGrid: 'grid gap-4 lg:grid-cols-3',
    searchLayout: 'lg:grid-cols-[280px_1fr]',
    commentFrame: 'border-[#8CC7C4]/35 bg-white',
  },
  'lasheminence.com': {
    key: 'salon-lookbook',
