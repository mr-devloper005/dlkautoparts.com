...
const variantShells = {
  'listing-directory': 'bg-[radial-gradient(circle_at_top_left,rgba(140,199,196,0.2),transparent_26%),linear-gradient(180deg,#fff6f6_0%,#ffffff_100%)]',
  'listing-showcase': 'bg-[linear-gradient(180deg,#ffffff_0%,#f5fcfb_100%)]',
